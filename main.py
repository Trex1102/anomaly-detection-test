...
def get_args():
    ...
    parser.add_argument('--classes', nargs="+", default=["fabric"])
...
def train(_class_, pars):
    ...
    epoch_map = {
        'carpet': 10, 'leather': 10,
        'grid': 260, 'tile': 260,
        'wood': 100,
        'cable': 240,
        'capsule': 300,
        'hazelnut': 160, 'metal_nut': 160,
        'screw': 280, 'toothbrush': 280,
        'transistor': 300, 'zipper': 300,
        'pill': 200, 'bottle': 200,
    }
    num_epoch = epoch_map.get(_class_, 200)  # default 200 for MVTec2 classes
    ...
    for epoch in tqdm(range(1,num_epoch+1)):
        ...
        if epoch % 10 == 0 or epoch == num_epoch:
            ...
            auroc_px, auroc_sp, aupro_px = 0.0, 0.0, 0.0
...
if __name__ == '__main__':
    ...
    all_classes = ['can', 'fabric', 'fruit_jelly', 'rice', 'sheet_metal', 'vial', 'wallplugs', 'walnuts']
    setup_seed(111)
